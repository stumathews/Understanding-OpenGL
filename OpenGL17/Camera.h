...
class CCamera {
public:
	CCamera(std::shared_ptr<gamelib::event_manager> event_admin); // Constructor - sets default values for camera position, viewvector, upvector, and speed
	~CCamera();										// Destructor
...
private:
	...
	const float m_rotationFactor = 0.005f;
