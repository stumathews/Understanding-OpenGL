...
{        
    ...
    static const GLchar* vertext_shader_source[] =
    {
        ...
        "  // We assign a unique color to each vertex, notie how OpenGL interpolates their values across the primative thats being rendered\n"
    ...
    static const GLchar* fragment_shader_source[] = 
    {
      ...
      "#version 450 core\n" // Use version 4.5 of the shader language and use the core profile of OpenGL
        ...
        "void main(void)\n"
        "{\n"
        "  // We can use the gl_FragCoord to get the location of the pixel, and colour it in accordingly\n"
        "  color = fs_in.color;\n"
        "}\n"
    };
