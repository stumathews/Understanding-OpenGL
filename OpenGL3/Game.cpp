...
void Game::Initialise() 
{
    ...
    static const GLchar* vertext_shader_source[] =
    {
        ...
        "                                   vec4(0.25, 0.25, 0.5, 1.0));\n"
        "  // Index into our hard coded postion array using gl_VertexID\n"
...
{	
    ...
    // Set the diameter of a point in pixels
    glPointSize(40.0f);

    // Send vertices into the OpenGL pipeline
    auto numVerticesToSend = 3;

    // What type of primative do we want to draw?
    auto mode = GL_POINTS;
