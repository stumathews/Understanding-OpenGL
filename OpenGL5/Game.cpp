...
{        
    ...
    static const GLchar* vertext_shader_source[] =
    {
        ...
        "                                   vec4(0.25, 0.25, 0.5, 1.0));\n"
        "  // Index into our hard coded postion array using gl_VertexID and factor in our offset\n"
...
{	
    ...
    // Data to send into vertex attribute 0
    GLfloat attrib[] = 
    {
        (float) sin(m_dt) * 0.5f,
        (float) cos(m_dt) * 0.6f,
    ...
    // Update vertex attribute 0 in the vertex shader every time this is called
