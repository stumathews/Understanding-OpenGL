...
{        
    ...
    // Create a buffer object in memory
    ...
    // Specify the data store parameters
    ...
    auto intendedUse = GL_MAP_READ_BIT | GL_MAP_WRITE_BIT;  // allow map for reading and writing to buffer
                       /* |
    ...
    // Bind buffer to context using the GL_ARRAY_BUFFER binding point - this suggests we are going to use the buffer for 
    // storing vertex data
    ...
    // Upload data directly by writing to the mapped bufffer
